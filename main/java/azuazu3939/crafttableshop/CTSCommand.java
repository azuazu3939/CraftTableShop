        ...
        try {
            ...
            if (string.equals("reload") || string.equals("Reload") || string.equals("RELOAD")) {
                ...
                try {
                    ...
                    sender.sendMessage("/cts add <string:path1> <string:path2>");
                    sender.sendMessage("/cts menu <name>");
                    sender.sendMessage("/cts get <name> <string:path>");
                    sender.sendMessage("/cts remove <string:path1> [<a-i> or true]");
                ...
                try {
                    ...
                    switch (Id) {
                        ...
                        case "b":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "b." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "c":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "c." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "d":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "d." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "e":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "e." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "f":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "f." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "g":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "g." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "h":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "h." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                        case "i":
                            ...
                            player.sendMessage(ChatColor.GREEN + "登録しました。Data " + type + "." + "i." + set + "." + amount);
                            CraftTableShop.getInstance().saveConfig();
                            CraftTableShop.getInstance().saveDefaultConfig();
                            return true;
                    }
                ...
                try {
                    ...
                    for (MythicItem mythicItem : MythicMobs.inst().getItemManager().getItems()) {
                        ...
                        if (tag.containsKey("MYTHIC_TYPE")) {
                            ...
                            CraftTableShop.getInstance().getSetUpConfig().getConfig().set("CraftData." + Id + "." + type, mm);
                            CraftTableShop.getInstance().getSetUpConfig().saveConfig();
                            CraftTableShop.getInstance().saveConfig();

                            sender.sendMessage(ChatColor.GREEN + "手に持っているアイテムを" + type + "という名前で" + Id + "に登録しました。(MythicMobs)");
                            return true;
                        }
                    }
